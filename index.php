...
<head>
    ...
    <link rel="shortcut icon" type="image/icon" href="papirus.ico">
</head>
...
<body>
    <div class="container">
        ...
        <form action="insert_berhasil.php" method="POST">
            <div class="card">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" id="inputIzinKelas" name="inputIzinKelas">
                                ...
                                <option>X IPA 4</option>
                                <option>X IPA 5</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" id="inputIzinGuru" name="inputIzinGuru">
                                ...
                                <option>Pak Agus S</option>
                                <option>Pak Agus I</option>
                                <option>Pak Yogi</option>
                                <option>Pak Istian</option>
                                <option>Pak Nashir</option>
                                <option>Pak Bahtiar</option>
                                <option>Bu Uyun</option>
                                <option>Bu Amel</option>
                                <option>Bu Amy</option>
                                <option>Bu Ashiyyyaaappp</option>
                            </select>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
