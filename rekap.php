...
$query = "SELECT * FROM form_izin_siswa";
?>
                ...
                <div class="card-header">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-4" style="text-align: end">
                            <a class="btn btn-primary" href="/app_izin/index.php">
                        ...
                        <tbody>
                            ...
                            if ($result = $connect->query($query)) {
                                while ($row = $result->fetch_assoc()) {
                                    $field1name = $row["id_izin"];
                                    $field2name = $row["izin_waktu"];
                                    $field3name = $row["izin_nama"];
                                    $field4name = $row["izin_kelas"];
                                    $field5name = $row["izin_guru"];
                                    $field6name = $row["izin_keperluan"];
